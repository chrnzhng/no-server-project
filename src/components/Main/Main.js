      ...
      <h1 className="title">Current Air Quality</h1>
        <SearchBar className="search" userInput={props.userInput} handleInputChange={props.userInputFunction} makeRequest={props.onButtonClick}/>
          <ListGroup className="title">
            ...
            <ListGroupItem><a href="http://blog.breezometer.com/hubfs/BAQI%20Scale%20-%20BreezoMeter%20Global%20Air%20Quality%20Index.png?t=1498228196392" target="blank">
                           <h5>AQI: {props.resultsObject.breezometer_aqi}</h5></a></ListGroupItem>   
            <ListGroupItem><h5>AQI Description: { props.resultsObject.breezometer_description }</h5></ListGroupItem>
            <ListGroupItem><a href="https://en.wikipedia.org/wiki/Air_pollution#Pollutants" target="blank">
                           <h5>Dominant Pollutant: { props.resultsObject.dominant_pollutant_canonical_name }</h5></a></ListGroupItem>
